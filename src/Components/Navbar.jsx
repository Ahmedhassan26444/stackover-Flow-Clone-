...
const Navbar = ({ onHomeClick }) => {
  ...
  return (
    ...
    overflow-y-auto border-r border-gray-200 bg-white self-start'>
      ...
      <a onClick={onHomeClick} className='pl-1 py-2 text-sm hover:bg-gray-100 flex items-center gap-3 cursor-pointer'>
        <Home className="w-5 h-5" />Home
      </a>

      <a href="#" className='pl-1 py-2 text-sm font-bold bg-gray-100 flex items-center gap-3'>
        <MessageCircleQuestion className="w-5 h-5" />Questions
      </a>
      ...
      <div className='pt-2 items-center text-[14px] text-center'>
        <button className='bg-blue-500 px-8 py-1.5 text-neutral-50 rounded-md
         items-center '>
          Try For Free
        </button>
      </div>
